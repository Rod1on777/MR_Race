...
public partial class @InputSystem_Actions: IInputActionCollection2, IDisposable
{
    ...
    ""maps"": [
        ...
        {
            ""name"": ""axis"",
            ""id"": ""823881dc-e13d-46d1-bc80-9dbb90f2014b"",
            ""actions"": [
                {
                    ""name"": ""Steer"",
                    ""type"": ""Value"",
                    ""id"": ""66873ce5-ba25-4313-8ddd-95b223eeec9e"",
                ...
                },
                {
                    ""name"": ""Accelerate"",
                    ""type"": ""Value"",
                    ""id"": ""ee1a6576-2dc0-4d45-b739-b064c542ca84"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
                },
                {
                    ""name"": ""Brake"",
                    ""type"": ""Value"",
                    ""id"": ""1b63fe75-430e-4bbc-80fe-2236b677e706"",
                    ""expectedControlType"": """",
                    ""processors"": """",
                    ""interactions"": """",
                    ""initialStateCheck"": true
            ...
            ""bindings"": [
                {
                    ""name"": ""Gamepad"",
                    ""id"": ""5942ef6a-e0a6-4447-8296-e83945b736fc"",
                    ""path"": ""2DVector"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""up"",
                    ""id"": ""62e18664-42a9-48b0-8aa3-e2d144589dc7"",
                    ""path"": ""<Gamepad>/rightStick/up"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""down"",
                    ""id"": ""40e1606c-9621-4c1f-9493-083c254b5c0b"",
                    ""path"": ""<Gamepad>/rightStick/down"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""left"",
                    ""id"": ""dd22a39d-356d-494c-9657-e72cbc3ba870"",
                    ""path"": ""<Gamepad>/rightStick/left"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": ""right"",
                    ""id"": ""5c15ef91-334b-4936-a2ba-56ae665b3eeb"",
                    ""path"": ""<Gamepad>/rightStick/right"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                ...
                {
                    ""name"": """",
                    ""id"": ""7eb9c062-aea3-487c-800a-defb41ab68f6"",
                    ""path"": ""<XRController>{RightHand}/deviceRotation/w"",
                    ""interactions"": """",
                    ""processors"": """",
                    ""groups"": """",
                    ""action"": ""Steer"",
                ...
                {
                    ""name"": """",
                    ""id"": ""ce8a3555-8f4c-4641-9e49-e4ac242dd91b"",
                ...
                {
                    ""name"": """",
                    ""id"": ""6afa4e65-3618-4669-b856-99d82f4ec05c"",
    ...
    ""controlSchemes"": [
        ...
        m_axis_Steer = m_axis.FindAction("Steer", throwIfNotFound: true);
        m_axis_Accelerate = m_axis.FindAction("Accelerate", throwIfNotFound: true);
        m_axis_Brake = m_axis.FindAction("Brake", throwIfNotFound: true);
    }
    ...
    ~@InputSystem_Actions()
    {
        ...
        UnityEngine.Debug.Assert(!m_axis.enabled, "This will cause a leak and performance issues, InputSystem_Actions.axis.Disable() has not been called.");
    }
    ...
    private readonly InputAction m_axis_Steer;
    private readonly InputAction m_axis_Accelerate;
    private readonly InputAction m_axis_Brake;
    /// <summary>
    /// Provides access to input actions defined in input action map "axis".
    /// </summary>
    public struct AxisActions
    {
        ...
        /// Construct a new instance of the input action map wrapper class.
        /// </summary>
        public AxisActions(@InputSystem_Actions wrapper) { m_Wrapper = wrapper; }
        /// <summary>
        /// Provides access to the underlying input action "axis/Steer".
        /// </summary>
        public InputAction @Steer => m_Wrapper.m_axis_Steer;
        /// <summary>
        /// Provides access to the underlying input action "axis/Accelerate".
        /// </summary>
        public InputAction @Accelerate => m_Wrapper.m_axis_Accelerate;
        /// <summary>
        /// Provides access to the underlying input action "axis/Brake".
        /// </summary>
        public InputAction @Brake => m_Wrapper.m_axis_Brake;
        /// <summary>
        /// Provides access to the underlying input action map instance.
        /// </summary>
        ...
        public bool enabled => Get().enabled;
        /// <summary>
        /// Implicitly converts an <see ref="AxisActions" /> to an <see ref="InputActionMap" /> instance.
        /// </summary>
        ...
        /// <summary>
        /// Unregisters <param cref="instance" /> and unregisters all input action callbacks via <see cref="AxisActions.UnregisterCallbacks(IAxisActions)" />.
        /// </summary>
        /// <seealso cref="AxisActions.UnregisterCallbacks(IAxisActions)" />
        ...
        /// If <paramref name="instance" /> is <c>null</c>, calling this method will only unregister all existing callbacks but not register any new callbacks.
        /// </remarks>
        /// <seealso cref="AxisActions.AddCallbacks(IAxisActions)" />
        /// <seealso cref="AxisActions.RemoveCallbacks(IAxisActions)" />
        /// <seealso cref="AxisActions.UnregisterCallbacks(IAxisActions)" />
    ...
    /// <summary>
    /// Provides a new <see cref="AxisActions" /> instance referencing this action map.
    /// </summary>
    ...
    /// <summary>
    /// Interface to implement callback methods for all input action callbacks associated with input actions defined by "axis" which allows adding and removing callbacks.
    /// </summary>
    /// <seealso cref="AxisActions.AddCallbacks(IAxisActions)" />
    /// <seealso cref="AxisActions.RemoveCallbacks(IAxisActions)" />
